...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, arg):
        ...
        Function that displays the string representation of a class
    ...
    def do_destroy(self, arg):
        ...
        Function that deletes a class instance of a given id."""
        argl = parse(arg)
        obj_dict = storage.all()
        if len(argl) == 0:
            print("** class name missing **")
    ...
    def do_all(self, arg):
        ...
        Function that displays string representations of all instances of
        a given class.
    ...
    def do_count(self, arg):
     ...
     def do_update(self, arg):
       ...
       <class>.update(<id>, <dictionary>)
        Function that Update a class instance of a given id by adding or updating
